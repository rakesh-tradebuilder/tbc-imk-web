...
class BladeRenderer {   /** @var array All of the registered extensions. */
     ...
     * if the constant BLADE_MODE is define, then it is used instead of this field.
     * @var int MODE_*
     */
    protected $mode;
    /** @var int BladeRenderer reads if the compiled file has changed. If has changed,then the file is replaced. */
    const MODE_AUTO=0;
    ...
    /**
     * Get the mode of the engine.See BladeRenderer::MODE_* constants
     * @return int
     */
     ...
     * @param $mode int See BladeRenderer::MODE_* constants
     * @return void
     */
    ...
    public function showError($id, $text, $critic = false)
    {
        ...
        echo "BladeRenderer Error [{$id}]:<br>";
